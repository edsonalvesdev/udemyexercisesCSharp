...
Console.WriteLine("Indique o código do exercício a ser executado");
Console.WriteLine("- C4E1 : Classes, atributos e métodos");
Console.WriteLine("- C4E2 : Membros estáticos");
Console.WriteLine("- C5E1 : Construtores, palavra \"this\" e sobrecarga");
Console.WriteLine("- C6E1 : Vetores");
Console.WriteLine("- C6E2 : Listas");
Console.WriteLine("- C6E3 : Matrizes");
...
switch (codigo) {
    ...
    case "C4E2":
        ...
        double sMedio = (f1.Salario + f2.Salario) / 2;
        Console.WriteLine("Salário médio = " + sMedio.ToString("F2", CultureInfo.InvariantCulture));
